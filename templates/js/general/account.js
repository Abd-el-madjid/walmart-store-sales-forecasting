...
// Trigger the 'change' event manually
            ...
            var dataEtat = switchInput.getAttribute("data-etat");
            ...
            switchInput.addEventListener("change", function () {
                if (switchInput.checked) {
                    switchInput.setAttribute("data-etat", "True");
                } else {
                    switchInput.setAttribute("data-etat", "False");
                }

                // Optional: Log the updated value of data-etat
                console.log("Updated data-etat:", switchInput.getAttribute("data-etat"));
            });
