...
function reclamation_info(event){
    ...
    const reclamation_text = row.querySelector('.text').textContent.trim().replace(/\s+/g, '');
    const reclamation_text_form = document.querySelector('.reclamation_text');
   
    reclamation_text_form.textContent = reclamation_text;
  

    const reclamation_object = row.querySelector('.object').textContent.trim().replace(/\s+/g, '');
  ...
  function reclamation_reply(event){
    const row = event.target.closest('.table-row_container');
    const reclamation_reponse = row.querySelector('.answer').textContent.trim().replace(/\s+/g, '');
